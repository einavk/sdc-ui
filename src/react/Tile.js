...
const Tile = ({headerText, miniHeader, headerColor, iconName, iconColor, className, onClick, children, dataTestId}) => {
	...
	return (
		<div className={`sdc-tile ${className || ''}`} onClick={onClick} data-test-id={dataTestId}>
			...
			<div className={`sdc-tile-2nd-header ${headerColor || ''}`}>{miniHeader}</div>
